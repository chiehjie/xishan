...
$_LANG['transfer_accounts'] = '转账金额';
$_LANG['money'] = '金额';
$_LANG['surplus_type_0'] = '充值';
$_LANG['surplus_type_1'] = '提现';
$_LANG['surplus_type_2'] = '转账';
...
$_LANG['unit_yuan'] = '元';
$_LANG['for_free'] = '赠品免费';
$_LANG['surplus_amount_error'] = '您要申请转账的金额超过了您现有的余额，此操作将不可进行！';
$_LANG['surplus_appl_submit'] = '您的转账申请已成功提交，请等待管理员的审核！';
...
$_LANG['edit_password_failure'] = '您输入密码不一致！';
$_LANG['edit_password_mobile'] = '您的手机号码已经注册或验证码错误，请重新申请！';
$_LANG['edit_password_xinxi'] = '您输入的信息有误，请重新输入！';
$_LANG['edit_password_name'] = '您的账号不存在，请重新输入！';
...
$_LANG['phone_register'] = '手机快速注册';
$_LANG['forget_passwd'] = '忘记密码';
$_LANG['register_password'] = '请设置登录密码';
$_LANG['password_see'] = '密码可见';
$_LANG['password_annotation'] = '密码由6-20位字母、数字或半角符号组成、不能是10以下纯数字/字母/半角符号/字母需区分大小写';
$_LANG['contact_client'] = '联系客服';
$_LANG['question_bug'] = '如果您遇到问题可以';
$_LANG['questions'] = '为了避免您手机遗失，请您填写真实信息，这将帮助您以后通过回答问题快速找回密码';
$_LANG['question_one'] = '问题一';
$_LANG['question_two'] = '问题二';
$_LANG['passwd_question'] = '提示';
$_LANG['sel_question'] = '请选择密码提示问题';
$_LANG['passwd_answer'] = '答案';

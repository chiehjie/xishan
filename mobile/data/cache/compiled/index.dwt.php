...
<div class="footer"  style="position:fixed;bottom:0;z-index:111;width:100%;background:#eee">
    <a href="<?php echo url('index/index');?>">
        <div class="myFooter">
            <img src="themes/default/images/images/menu_icon1.png" alt=""/>
            <p>首页</p>
        </div>
    </a>
    <a href="<?php echo url('category/index');?>">
        <div class="myFooter">
            <img src="themes/default/images/menu_icon2.png" alt=""/>
            <p>分类</p>
        </div>
    </a>
    ...
    <a href="<?php echo url('user/index');?>">
        <div class="myFooter">
            <img src="themes/default/images/menu_icon5.png" alt=""/>
            <p>我</p>
        </div>
    </a>
</div> 

...
<ul class="mui-table-view">
	...
	<li class="mui-table-view-cell mui-media">
        <a href="<?php echo url('user/account_transfer_bank');?>">
            <img class="mui-media-object mui-pull-left" src="themes/default/images/recharge.png">
            <div class="mui-media-body">
                <p class='mui-ellipsis'>转账到银行卡</p>
            </div>
        </a>
    </li>
</ul>

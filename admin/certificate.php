...
if ($_REQUEST['act']== 'list_edit')
{
    ...
    if(!$certificate['certificate_id']){
        $callback = $GLOBALS['xishan']->url()."admin/certificate.php?act=get_certificate";
...
elseif($_REQUEST['act']=='apply_bindrelation')
{
    ...
    $array_data['api_url'] = $xishan->url()."api.php";
...
elseif($_REQUEST['act']=='delete'){
    /* 检查权限 */
    admin_priv('certificate');
    $callback = $GLOBALS['xishan']->url()."admin/certificate.php?act=list_edit";

 ...
 */
 ...
 {
    global $db, $xishan, $start_date, $end_date;
    ...
    $sql = "SELECT count(distinct(u.user_id)) FROM " .$xishan->table('users')." AS u, ".$xishan->table('order_info')." AS o " .$where;
    ...
    $sql = "SELECT u.user_id, u.user_name, COUNT(*) AS order_num, " .$total_fee.
               "FROM ".$xishan->table('users')." AS u, ".$xishan->table('order_info')." AS o " .$where .

...
//会员管理权限
    ...
    $purview['11_users_delete']         = 'users_delete';
...
/*二次开发*/
    /*管理员管理*/
    $purview['my_admin_list']       = 'my_admin_list';//查看管理员
    $purview['my_admin_add']        = 'my_admin_add';//添加管理员
    $purview['my_admin_edit']       = 'my_admin_edit';//修改管理员
    $purview['my_admin_drop']       = 'my_admin_drop';//修改管理员

    /*菜品管理*/

    // $purview['01_goods_list']        = array('goods_manage', 'remove_back');
    // $purview['02_goods_add']         = 'goods_manage';
    $purview['01_my_dishes_list']         = array('goods_manage', 'remove_back');
    $purview['02_my_dishes_add']         = '02_my_dishes_add';
    $purview['my_dishes_class_list']         = array('cat_manage', 'cat_drop');
    $purview['my_dishes_class_add']         = 'my_dishes_class_add';
    $purview['my_dishes_class_drop']         = 'my_dishes_class_drop';
    // $purview['03_category_list']     = array('cat_manage', 'cat_drop');   //分类添加、分类转移和删除
    $purview['05_comment_manage']    = 'comment_priv';
    $purview['06_goods_brand_list']  = 'brand_manage';
    $purview['08_goods_type']        = 'attr_manage';   //商品属性
    ...
    $purview['52_virtual_card_change'] = 'virualcard';
    $purview['goods_auto']           = 'goods_auto';
    // $purview['my_dishes_list'] = 'my_dishes_list';
    // $purview['my_dishes_add'] = 'my_dishes_add';
    // $purview['my_dishes_edit'] = 'my_dishes_edit';
    // $purview['my_dishes_drop'] = 'my_dishes_drop';
    // $purview['my_dishes_class_list'] = 'cat_manage';
    // $purview['my_dishes_class_add'] = 'cat_drop';

    /*商家管理*/
    // $purview['my_store_list'] = 'bonus_manage';
    // $purview['my_store_add'] = 'my_store_drop';

    /*角色管理*/
    $purview['my_admin_role'] = 'admin_role_manage';
    $purview['my_admin_role_add'] = 'admin_role_drop';

    //会员管理
    $purview['my_users_list']        = 'users_manage'; //会员列表
    $purview['user_manage_add']    = 'user_manage_add'; //添加/修改会员
    $purview['my_users_alist']       = 'my_users_alist'; //无商家列表
    $purview['user_rank_list']       = 'user_rank';//会员授信等级
    $purview['user_rank_add']        = 'user_add';//会员充值提现申请
    $purview['user_account']         = 'surplus_manage';//充值和提现申请
    $purview['unreply_msg']          = 'feedback_priv'; //会员留言
    $purview['user_account_manage']  = 'account_manage'; //资金管理
    $purview['user_delete']         = 'user_delete'; //删除会员
    $purview['my_payee_list']        = 'my_payee_list'; //收款人列表
    $purview['my_payee_add']         = 'my_payee_add'; //添加修改收款人
    $purview['my_payee_drop']        = 'my_payee_drop'; //删除收款人
    $purview['my_pusher_list']         = 'my_pusher_list'; //添加/修改推送人
    $purview['my_pusher_add']         = 'my_pusher_list'; //添加/修改推送人
    $purview['my_pusher_drop']        = 'my_pusher_drop'; //删除推送人
?>
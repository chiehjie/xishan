...
/*二次开发开始*/
$_LANG['20_priv_admin'] = '管理员管理';
$_LANG['21_members']    = '会员管理';
$_LANG['23_priv_admin']    = '角色管理';
$_LANG['24_dishes']    = '菜品管理';
// $_LANG['25_store']    = '商家管理';

/*二次开发结束*/

//商品管理部分的权限
// $_LANG['goods_manage'] = '菜品添加/编辑';
// $_LANG['remove_back'] = '菜品删除/恢复';
$_LANG['01_my_dishes_list'] = '查看菜品列表';
$_LANG['02_my_dishes_add'] = '添加/修改菜品列表';
$_LANG['03_my_dishes_drop'] = '删除菜品';
$_LANG['my_dishes_class_list'] = '查看菜品分类';
$_LANG['my_dishes_class_add'] = '添加/编辑菜品分类';
$_LANG['my_dishes_class_drop'] = '删除菜品分类';
$_LANG['attr_manage'] = '菜品属性管理';
$_LANG['brand_manage'] = '菜品品牌管理';
$_LANG['comment_priv'] = '用户评论管理';
$_LANG['goods_type'] = '菜品类型';
$_LANG['tag_manage'] = '标签管理';
$_LANG['goods_auto'] = '菜品自动上下架';
$_LANG['topic_manage'] = '专题管理';
$_LANG['virualcard'] = '虚拟卡管理';
$_LANG['picture_batch'] = '图片批量处理';
$_LANG['goods_export'] = '菜品批量导出';
$_LANG['goods_batch'] = '菜品批量上传/修改';
$_LANG['gen_goods_script'] = '生成商品代码';
$_LANG['suppliers_goods'] = '供货商菜品管理';
...
/*二次开发开始*/
//管理员管理
$_LANG['my_admin_list'] = '查看管理员';
$_LANG['my_admin_add'] = '添加/修改管理员';
$_LANG['my_admin_drop'] = '删除管理员';

// 会员管理
$_LANG['users_manage'] = '会员列表';
$_LANG['user_manage_add'] = '添加/修改会员';
$_LANG['user_delete'] = '删除会员';
$_LANG['my_users_alist'] = '无商家列表';
$_LANG['user_rank'] = '会员授信等级';
$_LANG['user_add'] = '会员充值提现申请';
$_LANG['surplus_manage'] = '充值提现申请';
$_LANG['feedback_priv'] = '会员留言';
$_LANG['account_manage'] = '资金管理';
$_LANG['my_payee_list'] = '收款人列表';
$_LANG['my_payee_add'] = '添加/修改收款人';
$_LANG['my_payee_drop'] = '删除收款人';
$_LANG['my_pusher_list'] = '添加/修改推送人';
$_LANG['my_pusher_drop'] = '删除推送人';

//菜品管理
// $_LANG['my_dishes_list'] = '菜品列表';
// $_LANG['my_dishes_edit'] = '修改列表';
// $_LANG['my_dishes_add'] = '添加菜品';
// $_LANG['my_dishes_drop'] = '删除菜品';

// $_LANG['cat_manage'] = '菜品分类添加/编辑';
// $_LANG['cat_drop'] = '菜品分类删除';

//商家管理
// $_LANG['bonus_manage'] = '添加/编辑商家列表';
// $_LANG['my_store_drop'] = '删除商家';

//角色管理
$_LANG['admin_role_manage'] = '添加/编辑角色';
$_LANG['admin_role_drop'] = '删除角色';

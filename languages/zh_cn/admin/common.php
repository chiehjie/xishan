...
$_LANG['app_name'] = '熹善文化商城';
$_LANG['cp_home'] = '熹善后台管理中心';
$_LANG['copyright'] = '版权所有 &copy; 2016-'. date('Y') .' 熹善文化创意策划有限公司，并保留所有权利。';
...
$_LANG['24_dishes'] = '商品管理';
/*二次开发结束*/

/*二次开发*/
/*管理员管理*/
$_LANG['my_admin_list'] = '管理员列表';
$_LANG['my_admin_add'] = '添加管理员';

// /*菜单管理*/
// $_LANG['my_menu_list'] = '菜单列表';
// $_LANG['my_menu_add'] = '添加菜单';

/*会员管理开始*/

$_LANG['my_users_list'] = '会员列表';
$_LANG['my_payee_list'] = '获取收款人';
$_LANG['my_payee_add'] = '添加/修改收款人';
$_LANG['user_rank_list'] = '会员授信等级';
$_LANG['user_rank_add'] = '会员充值提现申请';
$_LANG['my_users_alist'] = '无商家会员列表';
$_LANG['user_account'] = '充值和提现申请';
$_LANG['user_account_manage'] = '资金管理';
$_LANG['unreply_msg'] = '会员留言';
$_LANG['my_pusher_list'] = '获取推送人列表';
$_LANG['my_pusher_add'] = '添加推送人列表';
/*会员管理结束*/

/*角色管理*/
$_LANG['my_admin_role'] = '角色管理';
$_LANG['my_admin_role_add'] = '添加角色';


/*商品管理*/
$_LANG['goods_manage'] = '商品列表';
$_LANG['01_my_dishes_list'] = '商品列表';
$_LANG['02_my_dishes_add'] = '添加商品';
$_LANG['my_dishes_class_list'] = '商品分类列表';
$_LANG['cat_manage'] = '商品分类列表';
$_LANG['my_dishes_class_add'] = '添加商品分类';
...
$_LANG['ad_list'] = '广告列表';
$_LANG['payee_list'] = '收款人列表';
$_LANG['payee_add'] = '添加收款人';
$_LANG['pusher_list'] = '推送人列表';
$_LANG['pusher_add'] = '添加推送人';
/* 报表统计 */

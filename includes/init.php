...
$db->set_disable_cache_tables(array($xishan->table('sessions'), $xishan->table('sessions_data'), $xishan->table('cart')));
...
if (!defined('INIT_NO_USERS'))
{
    ...
    $sess = new cls_session($db, $xishan->table('sessions'), $xishan->table('sessions_data'));

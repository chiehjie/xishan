...
class shopex47
{
    ...
    function process_cat()
    {
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            /* 插入分类 */
            if (!$db->autoExecute($xishan->table('category'), $cat, 'INSERT', '', 'SILENT'))
            {
                //return $db->error();
            }
        }
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            $type['enabled']    = '1';
            if (!$db->autoExecute($xishan->table('goods_type'), $type, 'INSERT', '', 'SILENT'))
            {
                //return $db->error();
            }
        }
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            if (!$db->autoExecute($xishan->table('attribute'), $attr, 'INSERT', '', 'SILENT'))
            {
                 //return $db->error();
            }
        }
    ...
    function process_brand()
    {
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            if (!$db->autoExecute($xishan->table('brand'), $brand, 'INSERT', '', 'SILENT'))
            {
                //return $db->error();
            }
        }
    ...
    function process_goods()
    {
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            /* 插入 */
            if (!$db->autoExecute($xishan->table('goods'), $goods, 'INSERT', '', 'SILENT'))
            {
                //return $db->error();
            }
            ...
            if ($row['linkclass'] != '')
            {
                ...
                foreach ($cat_id_list as $cat_id)
                {
                    ...
                    if (!$db->autoExecute($xishan->table('goods_cat'), $goods_cat, 'INSERT', '', 'SILENT'))
                    {
                        //return $db->error();
                    }
                }
            ...
            while ($attr = $this->sdb->fetchRow($res1))
            {
                ...
                if (!$db->autoExecute($xishan->table('goods_attr'), $goods_attr, 'INSERT', '', 'SILENT'))
                {
                    //return $db->error();
                }
            }
            ...
            if ($row['multi_image'])
            {
                ...
                foreach ($img_list as $img)
                {
                    ...
                    if (!$db->autoExecute($xishan->table('goods_gallery'), $goods_gallery, 'INSERT', '', 'SILENT'))
                    {
                        //return $db->error();
                    }
                }
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            if (!$db->autoExecute($xishan->table('link_goods'), $link_goods, 'INSERT', '', 'SILENT'))
            {
                //return $db->error();
            }
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            if (!$db->autoExecute($xishan->table('group_goods'), $group_goods, 'INSERT', '', 'SILENT'))
            {
                //return $db->error();
            }
        }
    ...
    function process_users()
    {
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            if (!$db->autoExecute($xishan->table('user_rank'), $user_rank, 'INSERT', '', 'SILENT'))
            {
                //return $db->error();
            }
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            if (!$db->autoExecute($xishan->table('users'), $user, 'INSERT', '', 'SILENT'))
            {
                //return $db->error();
            }
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            if (!$db->autoExecute($xishan->table('user_address'), $address, 'INSERT', '', 'SILENT'))
            {
                //return $db->error();
            }
        }
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            if ($row['gid'] > 0 && $row['levelid'] > 0 && !isset($temp_arr[$row['gid']][$row['levelid']]))
            {
                ...
                if (!$db->autoExecute($xishan->table('member_price'), $member_price, 'INSERT', '', 'SILENT'))
                {
                    //return $db->error();
                }
            }
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            if (!$db->autoExecute($xishan->table('user_account'), $user_account, 'INSERT', '', 'SILENT'))
            {
                //return $db->error();
            }
        }
    ...
    function process_article()
    {
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            if (!$db->autoExecute($xishan->table('article_cat'), $cat, 'INSERT', '', 'SILENT'))
            {
                //return $db->error();
            }
        }
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            if (!$db->autoExecute($xishan->table('article'), $article, 'INSERT', '', 'SILENT'))
            {
                //return $db->error();
            }
        }
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            if (!$db->autoExecute($xishan->table('friend_link'), $link, 'INSERT', '', 'SILENT'))
            {
                //return $db->error();
            }
        }
    ...
    function process_order()
    {
        ...
        while ($row = $this->sdb->fetchRow($res))
        {
            ...
            while ($row = $this->sdb->fetchRow($res1))
            {
                ...
                if (!$db->autoExecute($xishan->table('order_goods'), $goods, 'INSERT', '', 'SILENT'))
                {
                    //return $db->error();
                }
            }
    ...
    function process_config()
    {
        ...
        {
            $sql = "UPDATE " . $xishan->table('shop_config') . " SET " .
                    "value = '$value' " .

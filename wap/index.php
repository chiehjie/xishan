...
$article_array = $db->GetALLCached("SELECT article_id, title FROM " . $xishan->table("article") . " WHERE cat_id != 0 AND is_open = 1 AND open_type = 0 ORDER BY article_id DESC LIMIT 0,4");

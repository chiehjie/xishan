...
<div class="col-xs-12 myBody">
    <div class="userName">
        ...
        <div class="myMoney moneybox">
            ...
            <div class="fenge"></div>
            <div class="contant">
               <a href="<?php echo url('user/account_raply');?>"> <p class="money">熹币中心</p></a>
                 <?php $_from = $this->_var['user_money']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'user_money_0_34067700_1484819191');if (count($_from)):
    foreach ($_from AS $this->_var['user_money_0_34067700_1484819191']):
?> 
                <div class="money"><?php echo $this->_var['user_money_0_34067700_1484819191']['user_money']; ?></div>
    ...
    <div class="col-xs-12 myIcon linefirst">
        <div class="fontImg">
            <a href="<?php echo url('user/xuanzhezhifufangshi');?>">

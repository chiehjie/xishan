...
// }
    ...
    public function account_transfer_name(){
		...
		if($names==$_SESSION['user_name']){
			echo "<script>alert('不能向自己账户转账')</script>";
			$this->display('user_account_transfer_account.dwt');
		}else{
    ...
    public function my_getpassword_email() {
        ...
        // $res = $this->model->query($sql);
        // if($code == $_POST['code'] && $email == $res[0]['email']){
        //     $this->display('my_getpassword_last.dwt');
        // }else{
        //     $this->display('my_getpassword_three.dwt'); 
        // }
        // var_dump($code);exit;
          if($_SESSION['mobile'] == $_POST['email'] && $_SESSION['code'] == $_POST['code']){
    ...
    /*修改密码成功*/
     public function my_getpassword_last_email() {
        ...
        $sql = 'UPDATE ' . M()->pre . 'users' . " SET `password`='$password1' WHERE `email`='" . $mobile . "'";
        // var_dump($sql);exit;
        M()->query($sql);
    ...
    public function xuanzhezhifufangshi(){
        // var_dump(123);exit;
    ...
    public function recharge2(){
        // var_dump(123);exit;
         $this->display('my_recharge2.dwt');
    }
    /*银行卡充值金额成功*/
    public function recharge3(){
        // var_dump(123);exit;
         $this->display('my_recharge3.dwt');
    }
    /**
     * 注册
     */

...
<div class="main-div">
<form action="my_payee.php" method="post" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
  <table width="100%" id="general-table">
    <tr>
      <td  class="label">
        <!-- <a href="javascript:showNotice('NameNotic');" title="<?php echo $this->_var['lang']['form_notice']; ?>">
        <img src="images/notice.gif" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>"></a> --><?php echo $this->_var['lang']['payee_name']; ?></td>
      <td>
        <input type="text" name="payee_name" value="<?php echo $this->_var['ads']['payee_name']; ?>" size="35" />
        <!-- <br /><span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?> id="NameNotic"><?php echo $this->_var['lang']['payee_name_notic']; ?></span> -->
      </td>
    </tr>
 ...
 <?php endif; ?> -->
    ...
    <tr>
      <td  class="label"><?php echo $this->_var['lang']['payee_phone']; ?></td>
      <td>
        <input type="text" name="phone" value="<?php echo $this->_var['ads']['phone']; ?>" size="35" />
      </td>
    </tr>
    <tr>
      <td  class="label"><?php echo $this->_var['lang']['payee_account']; ?></td>
      <td>
        <input type="text" name="payee_account" value="<?php echo $this->_var['ads']['payee_account']; ?>" size="35" />
      </td>
    </tr>
    <!-- <tr>
    ...
    <tr>
       ...
       <td>
        ...
        <input type="hidden" name="id" value="<?php echo $this->_var['ads']['payee_id']; ?>" />
      </td>
    </tr>
 </table>
...
<script language="JavaScript">
  document.forms['theForm'].elements['payee_name'].focus();
  document.forms['theForm'].elements['phone'].focus();
  document.forms['theForm'].elements['payee_account'].focus();
  <!--
  ...
  function validate()
  {
    ...
    validator.required("payee_name",     payee_name_empty);
    validator.required("phone",     phone_empty);
    validator.required("payee_account",     payee_account_empty);

...
body{background: url(images/login_bg_01.jpg) no-repeat center center;width: 100%,height:100%}
    ...
    <div class="message"><?php echo $this->_var['login_err']; ?></div>
      ...
      <h3 class="logo-text ecshop-logo">
        ...
        <div class="controls first">
          ...
          <input class="input input-big" type="text" name="username" placeholder="<?php echo $this->_var['lang']['label_username']; ?>" />
        </div>
        <div class="controls two">
          ...
          <input class="input input-big" type="password" name="password" placeholder="<?php echo $this->_var['lang']['label_password']; ?>"/>
        </div>

...
<table width="100%" >
  <tr>
   ...
   <tr>
    ...
    <td><input type="text" name="phone" value="<?php echo $this->_var['user']['phone']; ?>" /></td>
  </tr>
...
<!--   <tr>
 ...
 <!--  <tr>
  ...
  <tr>
    <td class="label"><?php echo $this->_var['lang']['user_type']; ?>:</td>
    <td><?php echo $this->html_radios(array('name'=>'user_type','options'=>$this->_var['lang']['users_type'],'checked'=>$this->_var['user']['user_type'])); ?></td>
  </tr>
  <!-- <tr>
...
?>
  ...
  <!--  <tr>
    <td class="label"><?php echo $this->_var['lang']['phone']; ?>:</td>
    <td><input name="phone"  value="<?php echo $this->_var['user']['phone']; ?>" size="10" /></td>
  </tr> --> 
   <tr>

    <td class="label"><?php echo $this->_var['lang']['user_head']; ?></td>
    <td>
      <input type="file" name="user_head" ></td>
  </tr>  
...
function validate()
{
    ...
    if (document.forms['theForm'].elements['act'].value == "insert")
    {
        ...
        validator.required("confirm_password", no_confirm_password);
         validator.required("user_head", no_user_head);

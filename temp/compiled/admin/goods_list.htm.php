...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('商品图片'); ">商品图片</a></th>
...
?>
  <tr>
    ...
    <td class="first-cell" style="<?php if ($this->_var['goods']['is_promote']): ?>color:red;<?php endif; ?>"><img style="width:80px;height:80px;" src="../<?php echo $this->_var['goods']['goods_thumb']; ?>"></td>
    ...
    <td align="center">
      ...
      <a href="goods.php?act=delete&goods_id=<?php echo $this->_var['goods']['goods_id']; ?>" title="<?php echo $this->_var['lang']['trash']; ?>"><img src="images/icon_trash.gif" width="16" height="16" border="0" /></a>

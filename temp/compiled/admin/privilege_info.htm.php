...
<table width="100%">
 <tr>
    <td class="label"><?php echo $this->_var['lang']['admin_name']; ?></td>
    <td>
      <input type="text" name="admin_name" value="<?php echo htmlspecialchars($this->_var['user']['admin_name']); ?>" size="34" /><?php echo $this->_var['lang']['require_field']; ?></td>
  </tr> 
 ...
 <?php if ($this->_var['action'] == "add"): ?>
  ...
  <?php endif; ?>
   <tr>
    ...
    <td>
      <input type="text" name="phone" value="<?php echo htmlspecialchars($this->_var['user']['phone']); ?>" size="34" /></td>
  </tr> 
  
   <tr>
    <td class="label"><?php echo $this->_var['lang']['admin_head']; ?></td>
    <td>
      <input type="file" name="admin_head" /></td>
  </tr> 
...
?>
  ...
  <?php endif; ?>
  <?php if ($this->_var['select_category']): ?>
  <tr>
   <td class="label"><?php echo $this->_var['lang']['select_category']; ?></td>
    <td>
      <select name="category">
        <option value=""><?php echo $this->_var['lang']['select_please']; ?></option>
        <?php $_from = $this->_var['select_category']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'list');if (count($_from)):
    foreach ($_from AS $this->_var['list']):
?>
        <option value="<?php echo $this->_var['list']['cat_id']; ?>" <?php if ($this->_var['list']['cat_id'] == $this->_var['user']['cat_id']): ?> selected="selected" <?php endif; ?> ><?php echo $this->_var['list']['cat_name']; ?></option>
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
      </select><?php echo $this->_var['lang']['require_field']; ?>
    </td>
  </tr>
...
function validate()
{
  ...
  validator.required("category", category_empty);

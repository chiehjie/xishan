...
<table cellspacing='1' cellpadding='3' id='list-table'>
  <tr>
    <th><?php echo $this->_var['lang']['admin_name']; ?></th> 
     <th><?php echo $this->_var['lang']['admin_head']; ?></th>
     <th><?php echo $this->_var['lang']['admin_role']; ?></th>
    <th><?php echo $this->_var['lang']['last_time']; ?></th>
    <th><?php echo $this->_var['lang']['handler']; ?></th>
  </tr>
  <tr>
    <td>系统管理员</th> 
     <td><img style="width:50px;" src="images/logo.png"></th>
     <td>超级管理员</th>
    <td><?php echo empty($this->_var['list']['last_login']) ? 'N/A' : $this->_var['list']['last_login']; ?></th>
    <td>   &nbsp;</th>
  </tr>
...
?>
  <tr>
    <td class="first-cell" ><?php echo $this->_var['list']['admin_name']; ?></td>
    <td align="left"><img style="width:50px;" src="../data/admin_head/<?php echo $this->_var['list']['admin_head']; ?>"></td>
    <td align="center"><?php echo $this->_var['list']['role_name']; ?></td>

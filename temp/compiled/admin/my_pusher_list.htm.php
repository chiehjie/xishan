...
<table cellpadding="3" cellspacing="1">
  <tr>
    <th><?php echo $this->_var['lang']['pusher_id']; ?></th>
    <th><?php echo $this->_var['lang']['pusher_name']; ?></th>
    <th><?php echo $this->_var['lang']['pusher_phone']; ?></th>
    <th><?php echo $this->_var['lang']['pusher_account']; ?></th>
...
<!--     <td class="first-cell">
    ...
    <td align="left"><span><?php echo $this->_var['list']['pusher_id']; ?></span></td>
    <td align="center"><span><?php echo $this->_var['list']['pusher_name']; ?></span></td>
    <td align="center"><span><?php echo $this->_var['list']['pusher_phone']; ?></span></td>
    <td align="right"><span><?php echo $this->_var['list']['pusher_account']; ?></span></td>
...
<!--       <?php if ($this->_var['list']['position_id'] == 0): ?>
      ...
      <?php endif; ?> -->
      <a href="my_pusher.php?act=edit&id=<?php echo $this->_var['list']['pusher_id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><img src="images/icon_edit.gif" border="0" height="16" width="16" /></a>
      <a href="my_pusher.php?act=remove&id=<?php echo $this->_var['list']['pusher_id']; ?>" title="<?php echo $this->_var['lang']['remove']; ?>"><img src="images/icon_drop.gif" border="0" height="16" width="16" /></a></span>
    </td>
  </tr>
  <?php endforeach; else: ?>

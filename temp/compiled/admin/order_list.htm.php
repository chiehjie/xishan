...
?>
  <tr>
    ...
    <td align="center" valign="top"  nowrap="nowrap">
     ...
     <?php endif; ?>
     <?php if ($this->_var['order']['shipping_status']): ?>
     <br/><a href="javascript:;" onclick="kdniao.query('<?php echo $this->_var['order']['invoice_no']; ?>','<?php echo $this->_var['order']['shipping_name']; ?>')">查看物流</a>
     <?php endif; ?>
    </td>
  </tr>

...
?>
          <tr>
            ...
            <?php echo $this->_var['item']['order_status']; ?><?php if ($this->_var['item']['shipping_status']): ?><a href="javascript:void(0);" onclick="kdniao.query(<?php echo $this->_var['item']['invoice_no']; ?>)">(查看物流)</a> <?php endif; ?>
            </td>
...
?>
      ...
      <?php if ($this->_var['action'] == order_detail): ?>
        ...
        <?php echo $this->smarty_insert_scripts(array('files'=>'../plugins/kdniao/jquery.min.js')); ?>
        <?php echo $this->smarty_insert_scripts(array('files'=>'../plugins/kdniao/kdniao.js')); ?>
              <?php endif; ?>
        <table>
...
<?php echo $this->smarty_insert_scripts(array('files'=>'../plugins/kdniao/kdniao.js')); ?>
<script type="text/javascript">
<?php if ($this->_var['order']['order_status'] = 5): ?>
  kdniao.query('<?php echo $this->_var['order']['invoice_no']; ?>','<?php echo $this->_var['order']['shipping_name']; ?>');
<?php endif; ?>

    ...
    <div class="box">
      <div class="box_1">
        <div class="userCenterBox boxCenterList clearfix" style="_height:1%;">
          ...
          <style>
.avtar .img a{display:none;width:72px;height:23px;background:url(themes/default/images/change_avtar.gif);position:absolute;margin-left:44px;margin-top:93px}
...
<div class="Left avtar" style="float:left;width:122px;text-align:center;">
    <div onmouseout="this.className='img'" onmouseover="this.className='img hover'" class="img">
        ...
        <img src="<?php if ($this->_var['info']['avatar']): ?><?php echo $this->_var['info']['avatar']; ?><?php else: ?>images/avatar.gif<?php endif; ?>">
    </div>
</div>

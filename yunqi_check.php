...
if(isset($_GET['code']) && $_GET['code'] && $_GET['act']=='callback'){
    ...
    if($rs){
        ...
        if($certificate['certificate_id']){
            $url = $GLOBALS['xishan']->url()."yunqi_check.php?act=authority";
        }else{
            $url = $GLOBALS['xishan']->url()."install/index.php?step=done";
        }
    ...
    $callback = $GLOBALS['xishan']->url()."/yunqi_check.php?act=callback";
